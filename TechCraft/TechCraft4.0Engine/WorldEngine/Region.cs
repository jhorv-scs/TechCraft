...
namespace TechCraftEngine.WorldEngine
{
    ...
    public class Region
    {
        ...
        {
            //_blocks = new Block[WorldSettings.REGIONWIDTH,WorldSettings.REGIONHEIGHT,WorldSettings.REGIONLENGTH];
            _blockType = new BlockType[WorldSettings.REGIONWIDTH, WorldSettings.REGIONHEIGHT, WorldSettings.REGIONLENGTH];
        ...
        public void InitRegion() {
            for (int x = 0; x < WorldSettings.REGIONWIDTH; x++)
            {
                for (int y = 0; y < WorldSettings.REGIONHEIGHT; y++)
                {
                    ...
                    {
                        _blockType[x, y, z] = BlockType.None;
                        _faceInfo[x, y, z] = 0;
                    }
                }
            }
        ...
        private void BuildVertexBuffers()
        {
            ...
            for (int x = 0; x < WorldSettings.REGIONWIDTH; x++)
            {
                for (int y = 0; y < WorldSettings.REGIONHEIGHT; y++)
                {
                    for (int z = 0; z < WorldSettings.REGIONLENGTH; z++)
                    {
                        BlockType blockType = _blockType[x, y, z];
            ...
            {
                //_waterVertexBuffer = new VertexBuffer(_world.Game.GraphicsDevice, _waterVertexArray.Length * VertexPositionTextureShade.SizeInBytes, BufferUsage.WriteOnly);


                //_world.Game.GraphicsDevice, _waterVertexArray.Length * VertexPositionTextureShade.SizeInBytes, BufferUsage.WriteOnly);
            ...
            {
                //_modelVertexBuffer = new VertexBuffer(_world.Game.GraphicsDevice, _modelVertexArray.Length * VertexPositionTextureShade.SizeInBytes, BufferUsage.WriteOnly);
            ...
            {
               // _solidVertexBuffer = new VertexBuffer(_world.Game.GraphicsDevice, _solidVertexArray.Length * VertexPositionTextureShade.SizeInBytes, BufferUsage.WriteOnly);
            ...
            else
            {
                if (neighbourType == BlockType.Water)
                {
                    ...
                    else if (blockType == BlockType.Water)
                    {
                        ...
                        //block.FaceInfo &= (byte)(255 - (byte)bFace);
                        //neighbour.FaceInfo &= (byte)(255 - (byte)nFace);
