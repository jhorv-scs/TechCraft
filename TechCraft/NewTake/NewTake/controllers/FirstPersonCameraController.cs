    ...
    public class FirstPersonCameraController 
    {
        ...
        public void ProcessInput(GameTime gameTime)
        {
            ...
            //    camera.UpDownRotation += GamePad.GetState(Game.ActivePlayerIndex).ThumbSticks.Right.Y / 20;
                ...
                Mouse.SetPosition(camera.graphicsDevice.DisplayMode.Width / 2, camera.graphicsDevice.DisplayMode.Height / 2);
                
            _mouseMoveState = new MouseState(camera.graphicsDevice.DisplayMode.Width / 2,
                    camera.graphicsDevice.DisplayMode.Height / 2,
